...
export default function Contact() {
    ...
    return <>
        <Head>
            ...
            <meta property="og:description" content="Page de Contact de mon portfolio" />
        ...
        <main className={`${styles.container}  d-flex flex-column align-items-center container gap-5 pb-5 shadow-lg rounded-5 container-lg p-3  gap-5 mb-5 d-flex `}>
            ...
            <div className={`${styles.contact_wrapper} w-100 d-flex flex-column align-items-center  animate__animated animate__bounceInLeft`}>
                <form onSubmit={handleSubmit}  className={`${styles.contact_form} d-flex flex-column`} noValidate>
                    <h2>Contactez-Moi</h2>
                    <label>
                        Nom
                        <input type="text" required name='name' onChange={handleNomChange} onBlur={validateNom} />
                    </label>
                    {erreurNom &&
                    ...
                    <label htmlFor="">
                        EMAIL
                        <input type="email" name="email" id="" required onChange={handleCourrielChange} onBlur={valideCourriel} />
                    ...
                    <label htmlFor="">
                        Message
                        <textarea onChange={handleMessageChange} onBlur={validateMessage} name="message" id="" cols="30" rows="10" required></textarea>
                    </label>
                    {erreurMessage &&
                        <div className={styles.erreur}>
                            {erreurMessage}
