...
export default function Apropos() {
        ...
        <meta property="og:description" content="Page Appropos de mon portfolio"/>
        <meta property="og:image" content="https://jamesbell.vercel.app/james.png"/>
        
        </Head>
        <main className={`${styles.main} d-flex flex-column gap-5 container-lg shadow-lg rounded-5 p-3`}>
               <AproposContenu/>
               <Education/>
        </main>
        </>
