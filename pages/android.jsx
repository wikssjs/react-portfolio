...
export default function Projet1() {
  ...
  return <ProjetGrid titre='Android' icon="bi bi-android2">
    <ProjetElement image={ecommerce} type="Android Developement" nom="E-Commerce Android App" id={0} anim="animate__animated animate__bounceInLeft" video="/videos/ecommerce.mp4" github="https://github.com/wikssjs/JamesEcommerce" languages={["JAVA -", "ANDROID STUDIO -", "API"]} />
