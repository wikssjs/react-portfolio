...
export default function Projet2() {
    return <>
     <Head>
      ...
      <meta name="description" content="Page de projet Web de mon portfolio" />
      <meta property="og:title" content="JamesBell - Projet-Web" />
      <meta property="og:description" content="Page de Projet Web de mon portfolio" />
    ...
    <ProjetGrid titre="Website" icon="bi bi-globe">
        ...
        <ProjetElement id={4} image={meteo} type="Web development" nom="Weather Website"  video = "/videos/meteo.mp4" github="https://github.com/wikssjs/Weather-app" lien="https://james-worldweather.netlify.app" languages ={["HTML -","BOOTSTRAP -","JAVASCIPT -","API"]}/>
        <ProjetElement id={3} image={quiz} type="Web development" nom="Randow Quiz Game" video = "/videos/quiz.mp4" github="https://github.com/wikssjs/Quiz" lien="https://james-quiz.netlify.app" languages ={["HTML -","CSS -","JAVASCIPT -","API"]}/>
    </ProjetGrid>
    </>
