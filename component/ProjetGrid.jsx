...
export default function ProjetGrid({ children, titre, icon }) {
  ...
  return (
    <div className={`${styles.container}`}>
      <h1 className={`${styles.titre} text-center pb-5`}>
        <i className={icon}></i> {titre} <i className={icon}></i>
      </h1>
      <div
        className={`${styles.projet1}  animate__animated ${anim} row gap-5  justify-content-center align-items-center  m-auto`}
      >
        {children}
      </div>
    </div>
