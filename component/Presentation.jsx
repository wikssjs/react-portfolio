  ...
  return (
    <div className={`${styles.text} d-flex flex-column gap-`}>
      ...
      <div className={styles.description}>
        ...
        <p>
          Je suis un développeur compétent en CSS, HTML, JavaScript et
          frameworks. Je m&apos; efforce de créer des applications et des sites
          web performants en apprenant de nouveaux outils et en me
          perfectionnant.
        </p>
      </div>
    </div>
